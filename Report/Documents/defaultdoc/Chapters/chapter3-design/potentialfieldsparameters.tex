\section{Functions for the potential fields}
	...
	$dc =$ distance from unit to cliff or edge. \\
	$duc =$ distance from unit to cliff or edge. \\
	$dua =$ distance from current tile to nerest ally.
	...
	\subsection*{Edges and cliffs (Repulsive)}
		...
		\begin{displaymath}
			EdgesAndCliffs = \begin{cases}
					-f_{EAC} \times {dc} & \text{if } de \leq c\\
					0 & \text{if } dc > c
				\end{cases}		
		\end{displaymath}
