...
micromanagement.
	...
	\subsection{Build Orders}
		...
		Early game scouting(explained below) can help determine the opponent's build order and so you can counter their strategy.\\
	...
	\subsection{Information Gathering}
		...
		as how it process them. You do not want to waste too many resources finding out information otherwise you will waste units. 
			...
			\subsubsection{Map Knowledge}
				...
				tactics, and general strategy depends on how much data there is about the map. 				
	...
	\subsection{Macromanagement}
		...
		long games with massive battles. 
			...
			\subsubsection{Queuing}
				...
				in order to have the best economy. In some cases it can be an advantage to stop building workers and focus on spending resources on something else like a building.
...
%	\subsection{Unpredictability}
		...
		identify the opponent's playstyle in depth. Because the human can do a creative new build that the bot doesn't know and can't react to. 
