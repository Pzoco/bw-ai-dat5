...
In this test we are using the following values in the table \ref{a6g4_table}. Here we try with different values in the learning algorithm to see which ones would fit the best and which values make the agent learn or converge the fastest.
