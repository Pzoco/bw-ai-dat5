...
%Subconclusion
The previously explained methods of agent learning does not fit our state space, since we have a large state space and an approximation will be necessary. In section \ref{qlearning} we will explain what we use instead and how we have implemented it.
